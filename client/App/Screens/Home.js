...
export default function Home() {
  ...
  const handleAddHotelPress = () => {
    navigation.navigate('AddHotel');
  };

  const handleTotalUploadsPress = () => {
    navigation.navigate('Uploads'); // Navigate to Uploads page
  };

  const handleReservePress = () => {
    navigation.navigate('BookingDetails'); // Navigate to BookingDetails page
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.quickActionsContainer}>
        ...
        <TouchableOpacity style={styles.addButton} onPress={handleAddHotelPress}>
          <Text style={[styles.addButtonText, { color: 'black' }]}>Add Hotel</Text>
