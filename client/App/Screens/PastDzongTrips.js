...
export default function PastDzongTrips() {

  const navigation = useNavigation(); // Hook for navigation

  const handleImagePress = (imageUri, names, price) => {
    navigation.navigate('PastDzongTripDetails', { imageUri, names, price });
  };

  return (
    <SafeAreaView>
      <View style={styles.headerContainer}>
        <Text style={styles.headerText}>Trips &gt; Dzong</Text>
      </View>
      <View>
        <Text style={styles.detailText}>Dzongs</Text>
      </View>
