...
export default function BookingDetails() {
  ...
  const userData = [
    { id: '1', name: 'Logun Paul', mobile: '1234567890', id: '12345678gfdw', cid: '123456789', hotelName: 'Hotel le-meridien', timestamp: new Date().getTime() - 3600000 }, // 1 hour ago
    { id: '2', name: 'James Paul', mobile: '9876543210', id: 'hbuiuo76879', cid: '6754364532', hotelName: 'Druk Heirtage Residence', timestamp: new Date().getTime() - 7200000 }, // 2 hours ago
  ...
  // Function to open pop-up and set selected user
  ...
  // Render item function to render each user item
      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalText}>ROOM INFO</Text>
          ...
          <View style={styles.roomInfoContainer}>
            ...
            <View style={styles.valueContainer}>
              ...
              <Text style={styles.value}>320 XRP</Text>
              <Text style={styles.value}>Standard</Text>
              <Text style={styles.value}>2</Text>
            </View>
          </View>
          <View style={styles.guestInfo}>
            <Text style={styles.guestInfoHeading}>GUEST INFO</Text>
          </View>
          <View style={styles.userInfoContainer}>
            <View style={styles.labelContainerGuest}>
              <Text style={styles.label}>Name</Text>
              <Text style={styles.label}>Mobile Number</Text>
              <Text style={styles.label}>NFT ID</Text>
              <Text style={styles.label}>CID</Text>
            </View>
            <View style={styles.valueContainerGuest}>
              <Text style={styles.valueText}>{selectedUser?.name}</Text>
              <Text style={styles.valueText}>{selectedUser?.mobile}</Text>
              <Text style={styles.valueText}>{selectedUser?.id}</Text>
              <Text style={styles.valueText}>{selectedUser?.cid}</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  valueText: {
    marginBottom: 8, // Adjust the margin bottom to create space between each word
  },
