...
// import LoginNavigation from '../Navagations/LoginNavigation';
...
export default function Monastery() {
  ...
  const handleImagePress = (imageUri, name, price) => {
    navigation.navigate('MonasteryDetails', { imageUri, name, price });
  };
      ...
      {loading ? (
        ...
        <ScrollView>
          {dummyHotels.map((hotel, index) => (
            <View key={index}>
              <Swiper style={styles.swiper} showsButtons={false} activeDotColor="#00AF87">
