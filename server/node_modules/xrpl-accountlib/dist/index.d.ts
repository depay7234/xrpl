    ...
    DEFAULT_DEFINITIONS: {
        ...
        TRANSACTION_FLAGS_INDICES: {
            AccountSet: {
                ...
                asfAuthorizedNFTokenMinter: number;
                asfDefaultRipple: number;
                asfDepositAuth: number;
                asfDisableMaster: number;
                asfDisallowIncomingCheck: number;
                asfDisallowIncomingNFTokenOffer: number;
                asfDisallowIncomingPayChan: number;
                asfAllowTrustLineClawback: number;
                asfDisallowIncomingTrustline: number;
                asfDisallowXRP: number;
                asfGlobalFreeze: number;
                asfNoFreeze: number;
                asfRequireAuth: number;
                asfRequireDest: number;
                asfTshCollect: number;
            };
        };
        TRANSACTION_FLAGS: {
            Universal: {
                tfFullyCanonicalSig: number;
            };
            AccountSet: {
                tfRequireDestTag: number;
                tfOptionalDestTag: number;
                tfRequireAuth: number;
                tfOptionalAuth: number;
                tfDisallowXRP: number;
                tfAllowXRP: number;
            };
            TrustSet: {
                tfSetAuth: number;
                tfSetNoRipple: number;
                tfClearNoRipple: number;
                tfSetFreeze: number;
                tfClearFreeze: number;
            };
            OfferCreate: {
                tfPassive: number;
                tfImmediateOrCancel: number;
                tfFillOrKill: number;
                tfSell: number;
            };
            Payment: {
                tfNoRippleDirect: number;
                tfPartialPayment: number;
                tfLimitQuality: number;
            };
            PaymentChannelClaim: {
                tfRenew: number;
                tfClose: number;
            ...
            NFTokenMint: {
                ...
                tfOnlyXRP: number;
                tfTrustLine: number;
                tfTransferable: number;
                tfApproveTransfers: number;
                tfIssuerCanCancelOffers: number;
                tfIssuerApprovalRequired: number;
            };
            NFTokenCreateOffer: {
                tfSellToken: number;
                tfApproved: number;
            ...
            AMMDeposit: {
                tfLPToken: number;
                tfSingleAsset: number;
                tfTwoAsset: number;
                tfOneAssetLPToken: number;
                tfLimitLPToken: number;
            };
            AMMWithdraw: {
                tfLPToken: number;
                tfWithdrawAll: number;
                tfOneAssetWithdrawAll: number;
                tfSingleAsset: number;
                tfTwoAsset: number;
                tfOneAssetLPToken: number;
                tfLimitLPToken: number;
