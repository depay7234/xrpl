...
var networkTxFee = function (client, tx, keepCreatedConnectionAlive) {
    if (keepCreatedConnectionAlive === void 0) { keepCreatedConnectionAlive = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var _a, features, connection, networkId, getHooksTxFee, fee, _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, networkInfo(client, true // keep alive
                    )];
                case 1:
                    _a = _d.sent(), features = _a.features, connection = _a.connection, networkId = _a.networkId;
                        ...
                        return __generator(this, function (_e) {
                            switch (_e.label) {
                                ...
                                case 1:
                                    ...
                                    if (typeof networkId === "number" && networkId > 1024 && typeof transaction.NetworkID === "undefined") {
